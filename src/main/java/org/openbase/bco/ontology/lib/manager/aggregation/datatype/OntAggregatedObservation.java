 ...
 */
public class OntAggregatedObservation {
    ...
    /**
     * Method creates an aggregated ontology observation. It contains aggregated values of state changes from an unit for each providerService in a specific
     ...
     */
    public OntAggregatedObservation(final String providerService, final RDFNode stateValue, final String quantity, final String activityTime
    ...
    /**
     * Getter for aggregated observation data: providerService.
     *
